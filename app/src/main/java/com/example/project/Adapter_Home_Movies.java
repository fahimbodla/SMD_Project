...
public class Adapter_Home_Movies extends RecyclerView.Adapter<Adapter_Home_Movies.ViewHolder>
{
    Context context;
    ArrayList<show> movies;
  //  ArrayList<show> copy_movie;

    public Adapter_Home_Movies(Context context, ArrayList<show> movies) {
